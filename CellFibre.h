...
#ifndef included_CellFibre
#define included_CellFibre
...
public:
  ...
  static double dWdI1, dWdI4f, dWdI4s;

  static double mu;

  static DenseMatrix<double> Sp;

  static structCF Dmat;

  static void compute_CF_PK2(EquationSystems &es, const Elem *elem);
  static void compute_CF_PK2_iso();
  static void compute_CF_D_iso();
  static void compute_CF_D();
  static void compute_CF_PK2_aniso(EquationSystems &es, const Elem *elem);
  static void compute_CF_D_aniso();
